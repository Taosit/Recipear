	...
	return (
		<>
			...
			<p className="image-instruction">
				You can optionally add <b>one</b> image for each step
			</p>
			<div className="steps">
						...
						<div className="step-content">
							...
							{step.image ? (
								<div className="step-image-preview-area">
									...
									<button className="link" onClick={() => removeImage(i)}>
										Remove
									</button>
								</div>
							) : (
								<div className="choose-image-container">
									<label className="add-image-button" htmlFor="image-input">
										Add Image
									</label>
									<input
										type="file"
